...
function PrivacyPolicy() {
  return <StaticPageLayout title="Privacy Policy">
    ...
    <p>Delta Superstar Services (operating Ayusydah.com) respects your privacy and is committed to protecting your personal data in accordance with Malaysia&apos;s Personal Data Protection Act 2010 (PDPA).</p>
    ...
    <h3 className="font-semibold text-gray-800 pt-2">3. Payment Security</h3><p>Payments are processed securely through PayPal. We do not store your full card or bank account details on our servers.</p>
    ...
    <h3 className="font-semibold text-gray-800 pt-2">8. Contact</h3><p>For privacy-related questions, contact us at lsmu@hotmail.com or +60 11-7223 2047.</p>
  </StaticPageLayout>
}
