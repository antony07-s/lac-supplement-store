...
const trackingUrl = (courier, number) => {
  const query = encodeURIComponent(number)
  const urls = {
    'J&T Express': `https://www.jtexpress.my/track?waybill=${query}`,
    'Ninja Van': `https://www.ninjavan.co/en-my/tracking?id=${query}`,
    'Pos Laju': `https://tracking.pos.com.my/tracking/${query}`,
    'DHL eCommerce': `https://track.dhlparcel.com/?piececode=${query}`,
  }
  return urls[courier] || ''
}
