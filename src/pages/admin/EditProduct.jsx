  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.put(`/products/${id}`, {
        ...
        image: imageUrl,
        variants: variants.map((variant) => ({ ...variant, price: Number(variant.price), originalPrice: Number(variant.originalPrice) || Number(variant.price), stock: Number(variant.stock) })),
      })
