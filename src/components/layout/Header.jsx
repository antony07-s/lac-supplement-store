        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
            <div className="flex items-center justify-between gap-4 px-4 md:px-8 py-4 md:py-5">
                ...
                <div className="flex items-center gap-3 md:gap-6">
                    ...
                    <button className="hidden md:flex items-center relative text-gray-700 hover:text-brand-blue">
                        <Heart size={22} />
                    ...
                    {navItems.map((item, index) => {
                        ...
                        return (
                            <li
                                ...
                                className={`hover:text-brand-blue cursor-pointer relative pb-2 border-b-2 shrink-0 ${openItem === item ? 'border-brand-blue text-brand-blue' : 'border-transparent'
                                    }`}
                            >
                                <Link to={`/category/${encodeURIComponent(item)}`}>{item}</Link>

                                {openItem === item && navDropdowns[item] && (
                                    <div className={`absolute top-full pt-3 w-[720px] z-50 ${alignRight ? 'right-0' : 'left-0'}`}>
