...
function ProductReviews({ productId, refreshProduct }) {
  ...
  const loadReviews = useCallback(() => api.get(`/reviews/product/${productId}`).then((res) => setReviews(res.data)).catch(() => setReviews([])), [productId])
