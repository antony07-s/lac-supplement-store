...
function WhyChoose() {
  return <section className="overflow-hidden bg-[#f5f8f1]">
    <div className="page-shell grid gap-8 py-14 lg:grid-cols-[.9fr_1fr_1fr] lg:items-center">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-emerald-100"><img src="https://res.cloudinary.com/pggies6d/image/upload/v1787569045/ayusydah-products/kidney.jpg" alt="Natural AYUSYDAH wellness product" className="aspect-[4/3] w-full object-cover mix-blend-multiply" /><div className="absolute bottom-5 right-5 max-w-44 rounded-2xl bg-white/90 p-3 text-right font-serif text-lg italic leading-tight text-emerald-900">A healthier you, a brighter tomorrow</div><PackageCheck className="absolute left-5 top-5 text-emerald-800" size={32} /></div>
    </div>
  </section>
}
